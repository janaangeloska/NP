...
package kolokviumski2_ispitni._5;
...
class GenericCollection<T extends Comparable<T> & IHasTimestamp> {
    ...
    public void addGenericItem (String category, T element){
        collection.putIfAbsent(category,new TreeSet<>());
    ...
    public Map<String, Set<T>> byMonthAndDay(){
        return collection.values().stream()
                ...
                .collect(Collectors.groupingBy(
                        el->String.format("%02d-%02d",el.getTimestamp().getMonthValue(),el.getTimestamp().getDayOfMonth()),
                        TreeMap::new,
