...
class MoreExperience extends ChainEvaluator {
    public MoreExperience(Evaluator next) {
        super(next);
    }
...
class MoreCreditScore extends ChainEvaluator {
    public MoreCreditScore(Evaluator next) {
        super(next);
    }
