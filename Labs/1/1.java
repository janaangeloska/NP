...
final class IntegerArray{
    ...
    public double average(){
        return (double) Arrays.stream(a).sum() /length();
    }

    public IntegerArray getSorted(){
        int[] sortedValues = Arrays.copyOf(a, a.length);
        Arrays.sort(sortedValues);
        return new IntegerArray(sortedValues);
    }

    public IntegerArray concat(IntegerArray ia){
    int [] concatenated=new int [a.length+ia.length()];
    System.arraycopy(a,0,concatenated,0,a.length);
    System.arraycopy(ia.a,0,concatenated,a.length,ia.a.length);
    ...
    public String toString() {
        ...
        string.append(a[a.length-1]).append("]");
